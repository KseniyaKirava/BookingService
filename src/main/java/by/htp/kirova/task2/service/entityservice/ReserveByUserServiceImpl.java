...
/**
 * Contains methods which provide application to work with Reserve by User class.
 *
...
public class ReserveByUserServiceImpl implements BookingService<ReserveByUser> {
    ...
    @Override
    public boolean create(ReserveByUser entity) {
    ...
    @Override
    public boolean update(ReserveByUser entity) {
        throw new UnsupportedOperationException();
    }

    @Override
    public boolean delete(ReserveByUser entity) {
        throw new UnsupportedOperationException();
    }
}
