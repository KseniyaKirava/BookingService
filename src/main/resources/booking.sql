...
INSERT INTO `kirova`.`users` (`username`, `email`, `password`, `first_name`, `last_name`, `middle_name`, `enabled`) VALUES ('jsmith', 'j.smith@outlook.com', '3e4f201d4e20fcf7dc29d977339dfbb54a93b43d9f11e7e526034b0681ec6bf6', 'John', 'Smith', '', true);
